...
export const FormBlocks: React.FC = ({ type }) => {
  ...
  return (
    <div className="px-2">
      ...
      >
        <FiClipboard />
        <span className="ml-2">Form component</span>
      </button>
      ...
      >
        <FiHash />
        <span className="ml-2">Input field</span>
      </button>
      ...
      >
        <FiHash />
        <span className="ml-2">Textarea field</span>
      </button>
      ...
      >
        <FiList />
        <span className="ml-2"> Select and search field</span>
      </button>
      ...
      >
        <FiList />
        <span className="ml-2"> Key and value field</span>
      </button>
      ...
      >
        <FiList />
        <span className="ml-2">Swith field</span>
      </button>
      ...
      >
        <FiSave />
        <span className="ml-2"> Submit button</span>
      </button>
    </div>
  );
};
