            ...
            <>
              ...
              {key === "background" && (
                <>
                  ...
                  >
                    <option selected={block()?.attrs[key] === ""} value="">
                      Blank background
                    </option>
                    <option
                      selected={block()?.attrs[key] === "main-background"}
                      value="main-background"
                    >
                      Main background
                    </option>
                    <option
                      selected={block()?.attrs[key] === "light-background"}
                      value="light-background"
                    >
                      Lignt background
                    </option>
                    <option
                      selected={block()?.attrs[key] === "dark-background"}
                      value="dark-background"
                    >
                      Dark background
                    </option>
                    <option
                      selected={block()?.attrs[key] === "action-background"}
                    ...
                    <option
                      selected={
                        block()?.attrs[key] === "main-background-gradient"
                      }
