    ...
    <div>
      ...
      {selectedFile && (
        <>
          ...
          {fileLocalUrl && selectedFile?.type === "image/png" && (
            <img src={fileLocalUrl} style={{ width: "100%", height: "auto" }} />
          )}
        </>
      )}
      {selectedFile && (
        <div className="border-b px-2 pb-2 grid grid-cols-2 gap-1">
          <button className={buttonClass} onClick={handleSubmission}>
            Submit file
          </button>
          <button
